...
/**
 * Enabled Box iteration of MBoxSelection.
 * @author Hugo Queniat
 *
 */
public class EBoxSelection extends MBoxSelection implements ActionListener {
	...
	/**
	 * Constructor for the EBoxSelection
	 * @param menu EditMenu corresponding to the menu super attribute.
	 */
	public EBoxSelection(EditMenu menu) {
		super("Opened Route", menu);
